...
<div class="container">
    ...
    <div style="text-align:right">
        <h5>Bienvenue <?php echo $_SESSION['nom'].' '.$_SESSION['prenom']; ?> !!</h5>
        <a href="../controllers/deconnexion.controller.php"><button type="button" class="btn rounded-pill btn-info"> Déconnexion</button></a>
    </div>
